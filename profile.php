...
{	?>
	...
	<p style="width: 350px;">
			...
			<b>Name</b>  <input type="text" name="name" required="required" pattern="[a-zA-Z _]{4,15}" title="please enter only character  between 4 to 15 for  name" value="<?php echo htmlentities($result->FullName);?>" class="form-control" id="name" required="">
	</p> 

<p style="width: 350px;">
<b>Mobile Number</b>
<input type="text" class="form-control" name="mobileno" pattern="[0-9]{11,14}" title="please enter only numbers between 11 to 14 for mobile no." value="<?php echo htmlentities($result->MobileNumber);?>" id="mobileno"  required="">
</p>
...
<?php }} ?>
			...
			<p style="width: 350px;">
<button type="submit" name="submit6" class="btn-danger btn">Update</button>
			</p>
			</form>
